...
class PrivateRecipeAPITest(TestCase):
    ...
    def test_full_update(self):
        """Test full update update of a recipe."""

        recipe = create_recipe(
            user=self.user,
            title="Sample recipe",
            link="https,dads#ecacsd",
            description="Sample description",
        )
    ...
    def test_delete_other_users_recipe_error(self):
        """Test deleting another users recipe gives an error."""

        new_user = create_user(email="dwda@example.com", password="dawd2fsf3q")
    ...
    def test_create_recipe_with_new_ingredient(self):
        ...
        payload = {
            ...
            "time_minutes": 30,
            "price": Decimal("69.5"),
            "ingredients": [{"name": "Salt"}, {"name": "Flower"}],
        }
    ...
    def test_create_recipe_with_existing_ingredient(self):
        ...
        payload = {
            ...
            "time_minutes": 20,
            "price": Decimal("69.5"),
            "ingredients": [{"name": "Lemon"}, {"name": "Flower"}],
        }
    ...
    def test_update_recipe_assign_ingredient(self):
        ...
        ingredient2 = Ingredient.objects.create(name="chili", user=self.user)
