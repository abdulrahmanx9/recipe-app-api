...
class PublicUserApiTests(TestCase):
    ...
    def test_create_user_success(self):
        """Testing create user is successful."""
    ...
    def test_user_wtih_email_exists_error(self):
...
class PrivateUserAPITests(TestCase):
    ...
    def test_retrireve_profile_success(self):
    ...
    def test_post_me_notallowed(self):
        """Test POST are not allowed for me endpoint."""
